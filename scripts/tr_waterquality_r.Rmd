...
water_quality <- read.csv('/Volumes/GoogleDrive/My Drive/weel/tres rios/datasets/tr-water-quality/data/tr_waterquality_fielddata.csv', stringsAsFactors = FALSE)
